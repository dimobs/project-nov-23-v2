  ...
  <div className="w-full pt-5 px-4 mb-8 mx-auto relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-orange-900  dark:bg-black ">
    ...
    <div className="p-6">
      <div className="mb-3 flex items-center justify-between">
        <h5 className="block font-sans text-xl font-medium leading-snug tracking-normal text-blue-gray-900 antialiased dark:text-green-300">
         {room.name}
        </h5>
      ...
      <p className="block font-sans text-base font-light leading-relaxed text-gray-700 antialiased dark:text-green-100">
       {room.description}
      </p>
...
<div className="max-w-4xl py-16 xl:px-8 flex justify-center mx-auto">
  <div className="w-full mt-16 md:mt-0 ">
    <form 
    className="relative z-10 h-auto p-8 py-0 overflow-hidden border-y-orange-500 border-b-2 border-gray-300 rounded-sm shadow-2xl" 
    onSubmit={formSubmitAddComment}
    >
      <h3 className="mb-6 text-xl font-medium text-center dark:bg-slate-600 rounded-xl ">Write a comment as <p className='mb-5 mr-5 text-white inline'
      >
        {user} 
        </p></h3>
      <textarea
...
const RoomDetails = withAuth(RDetails)
